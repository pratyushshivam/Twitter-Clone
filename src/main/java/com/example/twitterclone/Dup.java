...
public class Dup extends AppCompatActivity {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.tweet:
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        tweet.saveInBackground(new SaveCallback() {
                            ...
                            public void done(ParseException e) {
                                if(e==null)
                                {
                                    Toast.makeText(Dup.this, "Tweet was successfully uploaded", Toast.LENGTH_SHORT).show();
                                }
                                else
                                {
                                    Toast.makeText(Dup.this, "Tweet failed!", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                ...
                builder.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(Dup.this, "Tweet not done", Toast.LENGTH_SHORT).show();
                        dialog.cancel();
                    }
                });
                builder.show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                {
                    Toast.makeText(Dup.this, "Followed " + users.get(position) +"!", Toast.LENGTH_SHORT).show();
                    // means now we will add the details about the followed user
                    ParseUser.getCurrentUser().add("isFollowing", users.get(position));
                }
                else
                {
                    Toast.makeText(Dup.this, "Unfollowed " + users.get(position) +"!", Toast.LENGTH_SHORT).show();
